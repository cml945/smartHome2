...
Frigate Integration 会自动在 HA 中创建 binary_sensor 实体。为避免冲突，建议每个 Zone 名称全局唯一；当前模板按 Zone 名生成实体：

```
binary_sensor.<zone名>_person_occupancy
```

示例：
- `binary_sensor.sofa_area_person_occupancy`
- `binary_sensor.dining_area_person_occupancy`
- `binary_sensor.bed_area_person_occupancy`
- `binary_sensor.bedroom_desk_area_person_occupancy`
- `binary_sensor.desk_area_person_occupancy`
